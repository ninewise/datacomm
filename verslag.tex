...
\begin{section}*{Kanaalcodering}
	...
	\end{eqnarray*}
	We simuleren nu encoderen en decoderen met productcode voor een willekeurige bit-sequentie van 10000 woorden lang en zoeken de fouten in vectoren van 88 bits (8 blokken x 11 bits per woord). \\ De resultaten vinden we in \ref{tab:2_6} en \ref{fig:2_6}.
	    	\begin{table}[h]
    		\centering	
    		\begin{tabular}{r|r|r}
